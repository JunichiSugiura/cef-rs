...
pub fn apply_close_all_browsers_requests_system(
    ...
    mut close_all_events: EventWriter<crate::browser::events::CloseAllBrowsersBrowserEvent>,
) {
    let mut n = 0u32;
    for ev in events.read() {
        n += 1;
        close_all_events.send(crate::browser::events::CloseAllBrowsersBrowserEvent {
